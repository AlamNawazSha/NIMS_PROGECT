...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['book_table'])) {
    ...
    $stmt = $pdo->prepare("INSERT INTO table_bookings (user_id, name, phone, guests, date, time, status) VALUES (?, ?, ?, ?, ?, ?, 'Pending')");
    
    if ($stmt->execute([$user_id, $name, $phone, $guests, $date, $time])) {
        echo "<script>alert('Table booked successfully!');</script>";
    } else {
        echo "<script>alert('Failed to book table. Please try again.');</script>";
    }
}
?>
...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>Alam Hoteal Booking</title>
   ...
   <!-- we have to change the logo -->
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="#booking-table" class="navbar-link hover-underline">
              <div class="separator"></div>
  ...
  <main>
    <article>
      ...
      <section class="hero text-center" aria-label="home" id="home">
        ...
        <a href="#booking-table" class="hero-btn has-after">
...
<!-- <section class="menu-section">
    ...
    <div class="menu-container">
            ...
            <a href="fullmenu.php">View Full Menu</a>
      ...
      <section class="reservation" id="booking-table">
        <div class="container">
...
<?php } ?>
            ...
            <form action="" class="form-left" method="POST" name="booking-table">
              ...
              <p class="form-text text-center">
                Booking request <a href="tel:+91-9590337483" class="link">+91-9590337483</a>
              ...
              <button type="submit" class="btn btn-secondary"  name="book_table">
                ...
                <span class="text text-2" aria-hidden="true">Book My Table</span>
            ...
            <div class="form-right text-center" style="background-image: url('./assets/images/form-pattern.png')">
              ...
              <a href="tel:+91-9590337483" class="body-1 contact-number hover-underline">+19-9590337483</a>
              ...
              <address class="body-4">
                Infantry Road, Bellary City,<br> Karnataka 5830101, India
              </address>
      ...
      <section class="section about text-center" aria-labelledby="about-label" id="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <a href="tel:+91-9590337483" class="body-1 contact-number hover-underline">+91-9590337483</a>

            <a href="readmore.php" class="btn btn-primary">
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  ...
                  <time class="publish-date label-2" datetime="2022-09-15">15/03/2025</time>
                </div>
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  ...
                  <time class="publish-date label-2" datetime="2022-09-08">08/03/2025</time>
                </div>
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  ...
                  <time class="publish-date label-2" datetime="2022-09-03">03/03/2025</time>
                </div>
